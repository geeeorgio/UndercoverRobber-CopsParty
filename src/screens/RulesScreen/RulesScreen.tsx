      ...
      <ScrollView contentContainerStyle={styles.scrollContent}>
        ...
        <View style={styles.textWrapper}>
          <CustomText extraStyle={styles.modalText}>
            ...
            both — the Robber knows nothing. Each player says one word connected
            to the location or keyword.
          </CustomText>

          <CustomText extraStyle={styles.modalText}>
            If you’re the Robber, blend in! If you’re a Cop, stay smart and
            don’t reveal too much. After everyone speaks, vote for who you think
            is the Robber.
          </CustomText>
